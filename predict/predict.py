...
class classfication_service():
    ...
    def build_model(self, model_path):
        ...
        '''
        #model = models.__dict__[args['arch']]()
        model = models.__dict__['resnet50'](pretrained=False, progress=False)
        ...
        if torch.cuda.is_available():
            ...
            modelState = torch.jit.load(model_path, map_location='cpu')
            model.load_state_dict(modelState)
        return model
...
if __name__ == '__main__':
    model_path = '../' + 'resnet50model_30_9808_9141.pth'
